...
const Appointment = () => {
  ...
  const getAvailableSlots = async()=>{
    ...
    for(let i=0; i < 7; i++){
      ...
      //  setting end timne of the date with index
      ...
      while(currentDate < endTime){
        ...
        // increasing 30 mins for next slot
  ...
  return (
    docInfo && (
      <div>
        ...
        <button className="bg-[#5f6fff] text-white text-sm font-light px-14 py-3 rounded-full my-6 cursor-pointer">Book an appoinment</button>
        </div>
