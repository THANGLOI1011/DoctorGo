  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        <button  onClick={() => setShowFilter(prev => !prev)} className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter ? "bg-[#5f6FFF] text-white " : ""}`}>Filter</button>
        ...
        <div className='w-full grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-4 ggap-y-6'>
          {
